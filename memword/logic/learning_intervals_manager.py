...
class LearningIntervalsManager:
    ...
    def handle_submitted_question(cls, question):
        cls._adjust_question_difficulty(question)

        interval_change = cls._get_interval_change(question)
    ...
    @classmethod
    def _get_interval_change(cls, question):
        base_change_percent = abs(cls.CONFIDENCE_LEVEL_TARGET - question.confidence_level)
